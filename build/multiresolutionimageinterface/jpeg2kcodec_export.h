...
#      define JPEG2KCODEC_EXPORT __attribute__((visibility("default")))
#    else
...
#    define JPEG2KCODEC_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef JPEG2KCODEC_DEPRECATED
#  define JPEG2KCODEC_DEPRECATED __attribute__ ((__deprecated__))
#endif
